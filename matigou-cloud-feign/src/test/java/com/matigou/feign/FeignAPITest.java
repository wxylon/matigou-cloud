...
@SpringBootTest(classes = com.matigou.feign.FeignAPITest.FeignConfig.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class FeignAPITest {
	...
	@RibbonClient(name = "test", configuration = com.matigou.feign.FeignAPITest.RibbonConfig.class)
